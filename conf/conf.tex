...
\SetTitle %
{社群組織之重要構成因素探討:成員分享行為及輔助分享資訊工具研究 \\ ---以g0v零時政府為例} %
{The Research of important constitution factor of Web community :Member sharing behavior and aid communication tool study\\ ---A g0v.com as an  example }
...
%\SetAdvisorChiNameX{王本正}          % 只設定中文名字
...
\SetAdvisorNameA{王本正}{Kenny Wang}
%\SetAdvisorNameB{B}{B}
%\SetAdvisorNameC{C}{C}
...
\SetKeywords{社群}{分享}{g0v}{非營利}{組織建構}
